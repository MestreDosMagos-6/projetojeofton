    ...
    <div class="box">
        <form action="editar.php" method="POST">
            <fieldset>
                ...
                <br>
                <div
                    class="inputBox"><input type="text" name="nome"
                        class="inputUser" value="<?php echo $nome; ?>" required><label
                        class="labelInput">Nome</label></div><br><br>
                <div
                    <div class="inputBox">
                    <input type="text" name="email" class="inputUser" value="<?php echo $email; ?>" required>
                ...
                <div class="inputBox">
                    <input type="text" name="cidade" class="inputUser" value="<?php echo $cidade; ?>" required>
                    <label class="labelInput">Cidade</label>
                </div>
                <br><br>

                <div class="inputBox">
                    <input type="text" name="estado" class="inputUser" value="<?php echo $estado; ?>" required>
                    <label class="labelInput">Estado</label>
                </div>
                <br><br>

                <div class="inputBox">
                    <input type="text" name="endereco" class="inputUser" value="<?php echo $endereco; ?>" required>
